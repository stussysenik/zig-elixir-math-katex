defmodule MathViz.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": [
        "compile",
        "cmd bunx @tailwindcss/cli -i assets/css/app.css -o priv/static/assets/css/app.css",
        "esbuild math_viz"
      ],
      "assets.deploy": [
        "cmd bunx @tailwindcss/cli -i assets/css/app.css -o priv/static/assets/css/app.css --minify",
